...
//                                                                          //     regardless of "show as expanded" setting ?>
        ...
        <?php endif; ?>
          ...
          <!------------------------------------------ #sidebar-second -->
        <?php if ($page['sidebar_first'] && $page['sidebar_second']) { // page has both left and right sidebars... ?>
          <div id="content" class="six columns">
        <?php } elseif ($page['sidebar_first'] || $page['sidebar_second']) { // page has one or the other sidebar... ?>
